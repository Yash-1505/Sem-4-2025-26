...
This repository serves as a centralized collection of reference materials, documentation, and technical implementations for core subjects in the 4th-semester curriculum.

📚 Course Overview
------------------

### 🖥️ Operating Systems (303105251)

*   **Focus:** Understanding kernel architecture, process management, and resource allocation.
    
*   **Key Topics:** CPU Scheduling (FCFS, SJF, RR), Deadlocks, Memory Management, and File Systems.
...
*   **Key Topics:** SDLC Models (Waterfall, Agile, Scrum), Requirement Analysis (SRS), Software Design, and Testing.
...
*   **Focus:** Building scalable web applications using the Python ecosystem.
...
_├── Operating-Systems/ # Scheduling algorithms and shell scripts_

_├── Software-Engineering/ # SDLC models and SRS documentation_
